...
val trustStoreType = sparkConf.get("spark.ssl.trustStoreType", "JKS")
...
spark.read.format("delta").load("swebhdfs://namenode.localtest.me:9871/tmp/delta-test/delta-test-table").show()
